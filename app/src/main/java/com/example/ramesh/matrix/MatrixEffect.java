package com.example.ramesh.matrix;
...
/**
 * Created by J.yugandhar on 16-06-2017.
 */
...
public class MatrixEffect extends View {
    ...
    private char[] cars     =   "FOCUSSOFTNET".toCharArray();
    ...
    private void drawText(){
        for (int i  =   0;i<txtPosByColumn.length;i++){
            ...
            canvas.drawText(""+cars[RANDOM.nextInt(cars.length)],
                        i*fontSize,txtPosByColumn[i]*fontSize,paintTxt);
